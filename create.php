...
if (isset($_POST['batal'])) {
    ...
    $create = mysqli_query($conn, "INSERT INTO mahasiswa(`nim`,`nama`,`jurusan`,`foto`) VALUES ('$nim', '$nama', '$jurusan', '$foto')");
    if($create){
        header("Location: read.php");
    }else {
    ...
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" required="required" placeholder="contoh : 1641010000" name="nim">
            </div>
