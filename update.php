...
elseif(isset($_POST["simpan"])){
  ...
  $update = mysqli_query($conn, "UPDATE mahasiswa SET nim='$nim', nama='$nama', jurusan='$jurusan', foto='$foto' WHERE id = $id");
if($update){
  header("Location: read.php");
    ...
    <input type="hidden" name="id" value="<?= $mahasiswa['id']?>">
      ...
      <div class="form-group">
        ...
        <select class="form-control" name="jurusan">
          ...
          <option value="S1 Akuntansi" <?php echo ($jurusan == 'S1 Akuntansi' ? 'selected' : '')?>>S1 Akuntansi</option>
        </select>
      </div>
